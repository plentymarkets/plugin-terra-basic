...
var BasicContactComponent = /** @class */ (function () {
    function BasicContactComponent(basicContactService) {
        ...
        this.class = 'test';
        this.nameArray = ['Joe', 'Jim', 'Jacob'];
        this.contactJost = { id: 0, firstName: '', lastName: '' };
        this.contactJostChange = new core_1.EventEmitter();
    }
    BasicContactComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.basicContactService.getSingleContact(107).subscribe(function (result) {
            _this.restContact = result;
            _this.contactJostChange.emit(result);
        }, function (error) {
            console.warn(error);
        });
    };
    ...
    ], BasicContactComponent.prototype, "contactJost", void 0);
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], BasicContactComponent.prototype, "contactJostChange", void 0);
